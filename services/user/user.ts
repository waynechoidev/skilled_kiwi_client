export type Suburb = typeof UserService.suburbMap[District][number];
export type District = typeof UserService.districtList[number];

export default class UserService {
  static phoneNumberPrefixList = [
    '020',
    '021',
    '022',
    '027',
